...
function About() {
    ...
    const experiences = [
        ...
        江ノ島水族館や東京海洋大学などに取材。学んだことをレポートにまとめ、学内発表を行った。
      `,
        },
        {
            year: '2023年',
            title: 'Web制作の独学開始',
            description: `
        大学2年後期からHTML/CSS/JavaScriptを独学で学び、Webサイト制作のスキルを習得。
      ...
      `,
        },
        {
            ...
            description: `
        フルリモートでのWeb制作インターンシップに参加し、クライアントのニーズに応じたWebサイトの制作を担当。
      ...
      `,
        },
        {
            ...
            description: `
        大学の友人の勧めでUnityコースに参加し、VRゲームの制作にも挑戦。
